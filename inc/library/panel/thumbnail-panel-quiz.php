<div class="thumbnail-panel thumbnail-panel-quiz pt-6 hidden">
	...
	<div class="flex flex-col gap-3">
		...
		<a href="/quiz-type-a.php" class="m-auto w-6/12 py-3 px-2 border border-slate-500 text-center drop-shadow-lg"> 
			<div> Try to Solve </div> 
		</a> 
