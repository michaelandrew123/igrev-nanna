...
if(!$theme_license_yc) exit("<center><span style='color:red; font-size:15px;'><b>Warning: DAONTHEME License is Missing!</b></span><br>You are an unauthorized user.<BR>E-MAIL : daontheme@daum.net</center>");
            ...
            <div class="gall_box">
                ...
                <div class="gall_con">
                    <div class="gall_img" >
						...
						<a href="<?php echo $list[$i]['wr_link1'] ?>" class="bo_tit" target="_blank">
						<?php }else{?>
					...
					<div style="margin-top:5px; font-size:1em; text-align:center;"><?php echo $list[$i]['wr_1'] ?>  <?php if ($is_checkbox) { ?><br><br><a href="<?php echo $list[$i]['href'] ?>" class="bo_tit" >관리자수정</a><?php }?></div>
					<!-- <div style="margin-top:5px; font-size:0.9em;"><?=cut_str(str_replace("&nbsp;","",strip_tags($list[$i][wr_content])),55)?></div> -->
