...
<section id="bo_w">
    ...
    <div class="bo_w_info write_div">
	 ...
	 <div class="write_div">
        <label for="wr_1" class="sound_only">이벤트기간</label>
	    <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input half_input" size="50" placeholder="이벤트기간 ex)2020.04.01 ~ 2020.05.31">
    </div>
	...
	<div>아래 링크를 등록하시면 리스트에서 글을 클릭하면 해당 링크로 바로 이동합니다.(최고관리자는 제외)</div>
	...
	<div>파일1에 리스트용 이미지를 올립니다. 파일1에 올린 이미지는 글 보기에 나타나지 않습니다.</div>
