	...
	<article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
		...
		<div class="bo_vl_opt">
        	...
        	<ul class="bo_vc_act">
                ...
                <?php if ($list[$i]['is_del']) { ?><li><a href="<?php echo $list[$i]['del_link']; ?>" onclick="return comment_delete();">삭제<i class="fa fa-trash-o"></i></a></li><?php } ?>
				<li><a href="#none" class="more_opt_close">닫기<i class="fa fa-times"></i></a></li>
            </ul>
        </div>
		<?php } ?>
        <script>
