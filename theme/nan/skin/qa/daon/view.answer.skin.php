    ...
    <header>
	    ...
	    <div id="ans_add">
			...
			<ul class="more_add">
				...
				<li><a href="<?php echo $answer_delete_href; ?>" class="btn_b01 btn" onclick="del(this.href); return false;" title="답변삭제">답변삭제<i class="fa fa-trash-o" aria-hidden="true"></i></a></li>
				<?php } ?>	
				<li><a href="#none" class="btn_b01 btn more_opt_close" title="메뉴닫기">메뉴닫기<i class="fa fa-times"></i> </a></li>
			</ul>
			<script>
				// 답변하기 옵션
