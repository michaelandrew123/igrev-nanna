...
<article id="bo_v">   
    ...
    <section id="bo_v_info">		
        ...
        <?php if($view['email'] || $view['hp']) { ?>
            ...
            <strong><i class="fa fa-envelope" aria-hidden="true"></i> <?php echo $view['email']; ?></strong>
            <?php } ?>
            <?php if($view['hp']) { ?>&nbsp;&nbsp;
	...
	<div id="bo_v_top">
		...
		<ul class="bo_v_com">
			...
			<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b011 btn" title="글쓰기"><i class="fa fa-pencil" aria-hidden="true"></i><span class="">문의등록</span></a></li><?php } ?>
			...
			<li>
				...
				<ul class="more_opt">
					...
					<li><a href="#none" class="btn_b01 btn more_opt_close1" title="메뉴닫기"><i class="fa fa-times"></i> 닫기</a></li>
				</ul>
			</li>
			<?php } ?>
		</ul>
    ...
    <section id="bo_v_rel">
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tr>
                ...
                <td class="td_stat"><span class="<?php echo ($rel_list[$i]['qa_status'] ? 'txt_done' : 'txt_rdy'); ?>"><?php echo ($rel_list[$i]['qa_status'] ? '<i class="fa fa-check-circle" aria-hidden="true"></i> 완료' : '<i class="fa fa-times-circle" aria-hidden="true"></i> 접수'); ?></span></td>
            </tr>
            <?php
            }
            ?>
