...
<div id="bo_list">
    ...
    <div class="bo_fx">
        <ul class="btn_bo_user">
        	<?php if ($is_checkbox) { ?>
            <li><button type="submit" name="btn_submit" value="선택삭제" title="선택삭제" onclick="document.pressed=this.value" class="btn btn_b011 "><i class="fa fa-trash-o" aria-hidden="true"></i><span class="">선택삭제</span></button></li>
            <?php } ?>
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b011 btn" title="문의등록"><i class="fa fa-pencil" aria-hidden="true"></i><span class="">문의등록</span></a></li><?php } ?>
