	...
	<div id="sit_ov_wrap">
	    ...
	    <div id="sit_pvi">
	        ...
	        for($i=1; $i<=10; $i++) {
	            ...
	            if($img) {
	                // 썸네일
	                $thumb = get_it_thumbnail($it['it_img'.$i], 150, 150);
	                $thumbnails[] = $thumb;
	                $big_img_count++;
	        ...
	        if($total_count > 0) {
	            ...
	            foreach($thumbnails as $val) {
	                ...
	                if ($thumb_count % 5 == 0) $sit_pvi_last = 'class="li_last"';
						...
						echo '<a href="#none" class="img_thumb">'.$val.'<span class="sound_only"> '.$thumb_count.'번째 이미지 새창</span></a>';
	                    echo '</li>';
	            }
	            echo '</ul>';
	        }
