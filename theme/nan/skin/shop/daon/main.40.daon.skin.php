...
foreach((array) $list as $row){
    ...
    $list_width = 100 / $this->list_mod -1.0;
    $list_height = $this->img_height + 2;

    echo "<li class=\"sct_li{$sct_last} plista\" style=\"padding:{$list_top_pad}px {$list_right_pad}% {$list_bottom_pad}% {$list_left_pad}px;width:{$list_width}%; margin:0 1.5% 1.5% 0; width:{$list_width}%;height:{$list_height}px\">\n";
