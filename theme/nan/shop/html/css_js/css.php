<?php
	...
	*/
	...
	if(!$common_css_src){
		$fname .= "".substr(str_replace("#",".",$theme_license_yc),0,-11).".".$css_license_yc;
		// $fname .= ".dt_ori.".substr(str_replace("#",".",$theme_license_yc),0,-11).".".$css_license_yc;
	}else{
	...
	$f_file = G5_THEME_PATH."/shop/html/css_js/".$fname;
