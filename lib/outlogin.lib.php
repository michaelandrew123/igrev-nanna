...
function outlogin($skin_dir='basic')
{
    ...
    ob_start();
    $outlogin_file_path = '/outlogin.skin.1.php';
    if ($is_member)
        $outlogin_file_path = '/outlogin.skin.2.php';
    if(is_file($outlogin_skin_path.$outlogin_file_path)){
        include_once($outlogin_skin_path.$outlogin_file_path);
    } else {
        include_once(G5_THEME_MOBILE_PATH.'/../'.G5_SKIN_DIR.'/outlogin/shop_nan/'.$outlogin_file_path);
    }
