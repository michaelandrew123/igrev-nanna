			...
			<div x-show.transition="step != 'complete'">	
				...
				<div class="border-b-2 py-4">
					...
					<div class="flex flex-col md:flex-row md:items-center md:justify-between">
						...
						<div class="flex-1">
							<div x-show="step == 1">
								<div class="text-lg font-bold text-gray-700 leading-tight">Step 1</div>
							</div>
							
							<div x-show="step == 2">
								<div class="text-lg font-bold text-gray-700 leading-tight">Step 2</div>
							</div>

							<div x-show="step == 3">
								<div class="text-lg font-bold text-gray-700 leading-tight">Step 3</div>
							</div>
						</div>

						

						<div class="flex items-center  " style="width: 100vw">
