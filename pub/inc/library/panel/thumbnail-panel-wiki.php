<div class="thumbnail-panel thumbnail-panel-wiki mt-6 hidden">
	
	<div class="flex flex-col gap-3">
		<div class="flex flex-row gap-2 items-stretch ">
			<!-- Thumbnail Image -->
			<img class="w-6/12 flex-1" src="https://thumbnail.imgbin.com/9/18/6/imgbin-page-page-eqEzfq0Wp9LUg5dSNaPraVN1v_t.jpg" alt="Mountain">
			<div class="flex flex-col w-6/12 flex-1 justify-between">
				...
				<div class="flex flex-col">
					<div class="font-bold">Title Title Title   </div>
					<div class="font-bold">Title Title  </div>
					<div class="mt-2 mb-2">Wiki</div>
	...
	<div class="mt-3 flex flex-col gap-2">
		<div class="flex flex-row gap-2"> 
			<img class="w-6/12" src="https://thumbnail.imgbin.com/9/18/6/imgbin-page-page-eqEzfq0Wp9LUg5dSNaPraVN1v_t.jpg" alt="Mountain">
		
			<div class="w-6/12">Lorem ipsum dolor sit amet consectetur adipiscing elit, urna consequat felis vehicula class ultricies mollis dictumst, aenean non a in donec nulla</div>
				...
				<div class=" 2">
					<div class="flex flex-row justify-between">
						<div class="flex flex-row gap-2 items-center"> 
							<div class="font-semibold">unusual_w</div>
	 				...
	 				<div>
	 					<div>Check out this interesting artucle I found. What do you guys think?</div>
	 				</div>
