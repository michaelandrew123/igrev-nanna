	...
	<div class=" mt-6">
			<div class="flex flex-row items-center justify-between "> 
				...
				<div class="flex flex-row gap-1">
					<a href="./sub-page.php" class="flex flex-row gap-1">
	...
	<div class=" mt-6">
			<div class="flex flex-row items-center justify-between "> 
				<div class="flex flex-row">
					...
					<div class="uppercase font-medium"> review </div> 
	...
	<div class=" mt-6">
			<div class="flex flex-row items-center justify-between "> 
				<div class="flex flex-row">
					...
					<div class="uppercase font-medium"> writing </div> 
	...
	<div class=" mt-6">
			<div class="flex flex-row items-center justify-between "> 
				<div class="flex flex-row">
					...
					<div class="uppercase font-medium"> mine </div> 
	...
	<div class=" mt-6">
			<div class="flex flex-row items-center justify-between "> 
				<div class="flex flex-row">
					...
					<div class="uppercase font-medium"> fav </div> 
